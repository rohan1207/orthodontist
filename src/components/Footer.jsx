        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              <a href="#" className="text-[#4B4B4B] hover:text-[#006D5B] transition-colors duration-300">Home</a>
              <a href="#" className="text-[#4B4B4B] hover:text-[#006D5B] transition-colors duration-300">Articles</a>
              <a href="#" className="text-[#4B4B4B] hover:text-[#006D5B] transition-colors duration-300">Top Books</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              <a href="#" className="text-[#4B4B4B] hover:text-[#006D5B] transition-colors duration-300">Exam Preparation</a>
              <a href="#" className="text-[#4B4B4B] hover:text-[#006D5B] transition-colors duration-300">Topic Summaries</a>
              <a href="#" className="text-[#4B4B4B] hover:text-[#006D5B] transition-colors duration-300">Academic Help</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              <a href="mailto:info@orthochronicles.com" className="text-[#4B4B4B] hover:text-[#006D5B] transition-colors duration-300">
                info@orthochronicles.com
              </a>
              <a href="#" className="text-[#4B4B4B] hover:text-[#006D5B] transition-colors duration-300">
                Support Center
              </a>
              <a href="#" className="text-[#4B4B4B] hover:text-[#006D5B] transition-colors duration-300">
                FAQ
