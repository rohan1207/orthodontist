        ...
        <div className="md:col-span-5">
          <div className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white/70 p-6 shadow-xl backdrop-blur-md">
            ...
            <div className="mt-5 text-center">
              ...
              <p className="text-sm text-stone-600">Orthodontist</p>
            </div>
        ...
        <div className="md:col-span-7">
          <div className="max-w-2xl">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                href="/book"
                className="rounded-full bg-green-500 px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-green-600"
              >
                Book a consultation
              </a>
              <a
