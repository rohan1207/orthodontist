...
const topBooksData = [
  {
    ...
    description: "The definitive guide covering diagnosis, treatment planning, and mechanics. A must-have for every orthodontic resident.",
  ...
  },
  {
    ...
    description: "A foundational text focusing on growth and development, and the biological basis of orthodontic treatment.",
  ...
  },
  {
    ...
    author: "Lee W. Graber",
    description: "An in-depth resource on advanced techniques, new technologies, and evidence-based practices in the field.",
  ...
  },
  {
    ...
    description: "A practical guide to applying the Alexander Discipline, focusing on efficient and predictable treatment mechanics.",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute right-0 top-0 bottom-0 w-[15px] bg-white shadow-inner transform-gpu"
             style={{ 
        ...
        >
          <div className="h-full flex flex-col p-6 md:p-8 bg-gradient-to-r from-white to-gray-50">
            <div className="flex-1">
              <h3 className="text-lg md:text-xl font-bold text-gray-800">{book.title}</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-base md:text-lg">
            A curated collection of essential textbooks and guides for every aspiring orthodontist. Dive into the foundational knowledge that shapes modern practice.
          </p>
        </div>
